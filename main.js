            ...
            if (defendPlanet === "chancellor") {
                    ...
                    case "2":
                        ...
                        if (serTwoChan1 === "camp") {
                            ...
                            var gameWin2 = alert("You are suddenly ambushed when you're almost to the LZ and you rush the Chancellor to the ship, which you see is landing in " +
                                ...
                                " away the alien invaders. Congradulations, you've sacrificed yourself to win the war. Game Win.");
                        }
                        break;
                    default:
                        alert("On the way to your objective, you get amushed by a group of SuperBots. They were expecting you there. I'm Sorry, you have died.");
                        break;
                }

            } else if (defendPlanet === "civilians") {
                var serOneCiv = prompt("You send out rescue crews to the nearby builings in the cities and find hundreds of people in the fire. The Methera Bot-Men were looking ford" +
                ...
                if (serOneCiv === "capital") {
                    ...
                    if (capitalWall === "ok") {
                        ...
                        var passwords = [quest1, quest2, quest3, quest4];
                        ...
                        if (serTwoCivCap === "left") {
                            ...
                            var serTwoCivCapRit = prompt("You enter a room full of hostages and you go to free them but a Bot-Man was behind you and fights you." +
                                ...
                                "from an ominous somputer console and you need to re use your password choices. (just type 'ok' again)");
                            ...
                            if (lock1 === password[0] && lock2 === password[1] && lock3 === password[2] && lock4 === password[3]) {
                                var gameWin1 = alert("You unlock the hostages and accidentally disengage the mothership's support. You killed millions of ruthless " +
                                    "Methera soldiers and drive the survivors away. Congradulations! You saved the Atrar Union. Game Win.")
                            }
                        }
                        ...
                        var gameLose1 = alert("You got one or more of your passwords wrong and the console calls for the mothership's support. Your actions cause the deaths " +
                            "of milliions and the fall of the the Atrar Union. Game Over.")
                    }
                }
                ...
                case "continue":
                    ...
                    switch (roll) {
                        ...
                        case "plan":
                            ...
                            switch (plan) {
                                case "sleep":
                                    alert("You slept thinking Soren Lynx wouldn't find you, and you had such a good sleep you never woke up ever again!!!!!!! GAME OVER!!!!!!!!");
                                    break;
                                case "surrender":
                                    alert("You surrender and you were thrown into the porpeler and the war is over You made all of your people die or become slaves. GAME OVER!!!!!!!");
                                    break;
                            }
                            break;
                    }
                    ...
                    if (fleePlanet === "nustrye") {
                        ...
                        switch (nustrye) {
                            case "break":
                                ...
                                if (breakChance >= .5) {
                                    var breakSuccess = prompt("You decide to try to break away. You fight off the first officer and manage to run fast enough and find a hiding place. " +
