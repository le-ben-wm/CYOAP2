    ...
    switch (startGame) {
        case "defend":
            ...
            if (defendPlanet === "chancellor") {
                ...
                switch (serOneChan) {
                    default:
                        alert("On the way to your objective, you get amushed by a group of SuperBots. They were expecting you. I'm Sorry, you have died.");
                        break;
                }
                    ...
                    if (capitalWall === "ok") {
                        ...
                        if (serTwoCivCap === "left") {
                            ...
                            var serTwoCivCapRit = prompt("You enter a room full of hostages and you go to free them but a Bot-Man was behind you and fights you." +
                                " You see his half-man, half-robot is weakest where the flesh and metal combine together. You strike ")
                        }
